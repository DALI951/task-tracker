...
class SettingsService extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'create_employee_first': 'Create an employee before creating tasks.',
      'add_item': 'Add Item',
      'pending': 'Pending',
      'doing': 'In Progress',
      'done': 'Done',
      ...
      'notif_task_status_changed_msg': 'status has been updated',
      ...
      'preparing_photos': 'Preparing photos…',
      'no_reports_yet': 'No reports yet',
      'never': 'Never',
      'later': 'Later',
      'install': 'Install',
      'downloading_update': 'Downloading update…',
      'downloading_background': 'Downloading the update in the background…',
      'download_failed': 'Download failed. Check your connection and try again.',
      'download_missing': 'Download missing. Please download again.',
      'update_ready': 'Update ready — tap Install to finish',
      ...
      'failed_create_preset': 'Failed to create preset',
      'add_photo_or_description': 'Add a photo or enter a description',
      'upload_stopped': 'Upload stopped',
      'notif_task_submitted': 'Task submitted',
      'notif_uploading_task': 'Uploading task…',
      'notif_uploading_report': 'Uploading report…',
      'notif_photo': 'Photo',
      'notif_approved_short': 'approved',
      'notif_sent_review_short': 'sent for review',
      'notif_problem_sent': 'was sent to the manager',
      'notif_update_ready': 'Update ready to install',
      'notif_downloaded': 'downloaded',
      'manager_password_prompt': 'Enter your manager password to create this account. You will only be asked once per session.',
      'send_reset_email': 'Send Reset Email',
      'email_already_used': 'Email already used — choose another email',
      'confirm_password': 'Confirm your password',
      'continue': 'Continue',
      'reset_password': 'Reset Password',
      'reset_email_confirm': 'Send a password-reset email to',
      'reset_they_set': 'They will set a new password themselves.',
      'delete_employee': 'Delete Employee',
      'delete_employee_after': 'They will no longer be able to sign in. The account will be fully removed when the new backend is available.',
      'delete_notification_q': 'Delete notification?',
      'withdraw_submission': 'Withdraw submission',
      'upload_stopped_title': 'Upload stopped',
      'upload_error_no_internet': 'No internet connection',
      'upload_error_timeout': 'Connection timed out',
      'upload_error_server': 'Server error',
    ...
    'fr': {
      ...
      'create_employee_first': 'Créez un employé avant de créer des tâches.',
      ...
      'notif_task_status_changed_msg': 'a été mise à jour',
      ...
      'downloading_background': 'Téléchargement de la mise à jour en arrière-plan…',
      'download_failed': 'Échec du téléchargement. Vérifiez votre connexion et réessayez.',
      'download_missing': 'Téléchargement manquant. Veuillez télécharger à nouveau.',
      'update_ready': 'Mise à jour prête — appuyez sur Installer pour terminer',
      ...
      'failed_add_item': 'Échec de l\'ajout de l\'élément',
      'preset_created': 'Modèle créé',
      'failed_create_preset': 'Échec de la création du modèle',
      'add_photo_or_description': 'Ajoutez une photo ou une description',
      'upload_stopped': 'Téléchargement arrêté',
      'notif_task_submitted': 'Tâche soumise',
      'notif_uploading_task': 'Téléchargement de la tâche…',
      'notif_uploading_report': 'Téléchargement du rapport…',
      'notif_photo': 'Photo',
      'notif_approved_short': 'approuvée',
      'notif_sent_review_short': 'envoyée pour validation',
      'notif_problem_sent': 'a été envoyé au gestionnaire',
      'notif_update_ready': 'Mise à jour prête à installer',
      'notif_downloaded': 'téléchargé',
      'manager_password_prompt': 'Entrez votre mot de passe gestionnaire pour créer ce compte. Vous ne serez interrogé qu\'une fois par session.',
      'send_reset_email': 'Envoyer l\'e-mail de réinitialisation',
      'email_already_used': 'E-mail déjà utilisé — choisissez un autre e-mail',
      'confirm_password': 'Confirmez votre mot de passe',
      'continue': 'Continuer',
      'reset_password': 'Réinitialiser le mot de passe',
      'reset_email_confirm': 'Envoyer un e-mail de réinitialisation à',
      'reset_they_set': 'Ils définiront eux-mêmes un nouveau mot de passe.',
      'delete_employee': "Supprimer l'employé",
      'delete_employee_after': 'Ils ne pourront plus se connecter. Le compte sera entièrement supprimé lorsque le nouveau backend sera disponible.',
      'delete_notification_q': 'Supprimer la notification ?',
      'withdraw_submission': 'Retirer la soumission',
      'upload_stopped_title': 'Téléchargement arrêté',
      'upload_error_no_internet': 'Pas de connexion internet',
      'upload_error_timeout': 'Délai de connexion dépassé',
      'upload_error_server': 'Erreur du serveur',
    ...
    'ar': {
      ...
      'create_employee_first': 'أنشئ موظفًا قبل إنشاء المهام.',
      'add_item': 'إضافة عنصر',
      ...
      'notif_task_status_changed_msg': 'تم تحديث حالتها',
      ...
      'interrupted': 'متوقف',
      'problem_reported': 'تم الإبلاغ عن المشكلة',
      'preparing_photos': 'جاري تجهيز الصور…',
      'no_reports_yet': 'لا توجد تقارير بعد',
      'never': 'أبداً',
      'later': 'لاحقاً',
      'install': 'تثبيت',
      'downloading_update': 'جاري تحميل التحديث…',
      'downloading_background': 'جاري تحميل التحديث في الخلفية…',
      'download_failed': 'فشل التحميل. تحقق من اتصالك وحاول مرة أخرى.',
      'download_missing': 'التحميل مفقود. يرجى التحميل مرة أخرى.',
      'update_ready': 'التحديث جاهز — اضغط تثبيت للإنهاء',
      'whats_new': 'ما الجديد',
      ...
      'preset_created': 'تم إنشاء القالب',
      'failed_create_preset': 'فشل إنشاء القالب',
      'add_photo_or_description': 'أضف صورة أو وصفاً',
      'upload_stopped': 'تم إيقاف الرفع',
      'notif_task_submitted': 'تم تقديم المهمة',
      'notif_uploading_task': 'جاري رفع المهمة…',
      'notif_uploading_report': 'جاري رفع التقرير…',
      'notif_photo': 'صورة',
      'notif_approved_short': 'تمت الموافقة عليها',
      'notif_sent_review_short': 'أُرسلت للمراجعة',
      'notif_problem_sent': 'تم إرساله إلى المدير',
      'notif_update_ready': 'التحديث جاهز للتثبيت',
      'notif_downloaded': 'تم تحميله',
      'manager_password_prompt': 'أدخل كلمة مرور المدير الخاصة بك لإنشاء هذا الحساب. سيُطلب منك مرة واحدة فقط لكل جلسة.',
      'send_reset_email': 'إرسال بريد إعادة التعيين',
      'email_already_used': 'البريد مستخدم بالفعل — اختر بريداً آخر',
      'confirm_password': 'تأكيد كلمة المرور',
      'continue': 'متابعة',
      'reset_password': 'إعادة تعيين كلمة المرور',
      'reset_email_confirm': 'إرسال بريد إعادة تعيين إلى',
      'reset_they_set': 'سيقومون بتعيين كلمة مرور جديدة بأنفسهم.',
      'delete_employee': 'حذف الموظف',
      'delete_employee_after': 'لن يتمكنوا من تسجيل الدخول بعد الآن. سيتم حذف الحساب بالكامل عند توفر النظام الخلفي الجديد.',
      'delete_notification_q': 'حذف الإشعار؟',
      'withdraw_submission': 'سحب التسليم',
      'upload_stopped_title': 'توقف الرفع',
      'upload_error_no_internet': 'لا يوجد اتصال بالإنترنت',
      'upload_error_timeout': 'انتهت مهلة الاتصال',
      'upload_error_server': 'خطأ في الخادم',
